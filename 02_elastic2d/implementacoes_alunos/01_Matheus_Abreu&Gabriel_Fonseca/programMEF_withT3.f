...
c
      nin  = 1
      nout = 2
      print*, 'Arquivo de dados .dat:'
      read(*,'(a)') fname
      open(nin,file=fname)
      print*, 'Arquivo de saida .dat:'
      read(*,'(a)') fname
...
c ======================================================================
      ...
      subroutine vtkst3(e,ie,ix,id,x,f,u,
     .                  nnode,numel,nen,ndm,ndf,nvtk)

      integer nnode,numel,nen,ndm,ndf,nvtk
      integer ie(*)
      integer ix(nen+1,*)
      integer id(ndf,*)
...
c-----------------------------------------------------------------------
c       Recupera deslocamentos nodais
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
c       Derivadas das funcoes de forma
c-----------------------------------------------------------------------
